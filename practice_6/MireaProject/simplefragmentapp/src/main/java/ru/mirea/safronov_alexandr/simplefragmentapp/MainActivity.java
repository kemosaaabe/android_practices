...
public class MainActivity extends AppCompatActivity {
    Fragment fragment1, fragment4, fragment3, fragment5, fragment6, fragment7;
    Fragment fragment8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment7 = new SettingsFragment();
        fragment8 = new StoriesFragment();
    ...
    public void onClickFragment7(View view) {
        fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.fragmentContainer, fragment7).commit();
    }

    public void onClickFragment8(View view) {
        fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.fragmentContainer, fragment8).commit();
    }
